...
fitness_cleaned <- readRDS('../data/pipeline/fitness.rds')
...
```{r}
kmeans_swimming <- read_parquet('../data/pipeline/kMeans_swimming.parquet')
...
```{r}
ocsvm_swimming <- read_parquet('../data/pipeline/oneClassSVM_swimming.parquet')
...
```{r}
autoencoder_swimming <- read_parquet('../data/pipeline/autoencoder_swimming.parquet')
...
```{r}
kmeans_running <- read_parquet('../data/pipeline/kMeans_running.parquet')
...
```{r}
ocsvm_running <- read_parquet('../data/pipeline/oneClassSVM_running.parquet')
...
```{r}
autoencoder_running <- read_parquet('../data/pipeline/autoencoder_running.parquet')
